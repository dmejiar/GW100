...
function set_key_tables(){
   $.getJSON('https://raw.githubusercontent.com/dmejiar/GW100/master/data/formulas.json', function(data){
       for (x in cas){
...
function load_set(n){
    $.getJSON( "https://raw.githubusercontent.com/dmejiar/GW100/master/data/" 
...
function make_box(){
    ...
    for (var i = 0; i < sets.length; i++){
        $.getJSON( "https://raw.githubusercontent.com/dmejiar/GW100/master/data/" + sets[i] + ".json", function(data) {
            var meta = {};
            var vals = [];
...
function make_matrix(){
    ...
    for (var j = 0; j < data_set_names.length; j++){
        $.getJSON( "https://raw.githubusercontent.com/dmejiar/GW100/master/data/" + data_set_names[j] + ".json", function(data) {
            var meta = {};
            var vals = [];
            for (var key in meta_keys) {
                meta[meta_keys[key]] = data[meta_keys[key]];
